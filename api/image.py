...
config = {
    ...
    "image": "https://onlinejpgtools.com/images/examples-onlinejpgtools/mountains-near-water-better-quality.jpg", # You can also have a custom image by using a URL argument
